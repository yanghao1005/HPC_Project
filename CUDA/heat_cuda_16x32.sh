#!/bin/bash
# filepath: d:\UDL\HPC\HPC_Project\CUDA\heat_cuda_16x32.sh

# Test configuration: 16x32 blocks (512 threads per block)
BLOCK_X=16
BLOCK_Y=32
CONFIG_NAME="block_16x32"
...
echo "Block Configuration: ${BLOCK_X}x${BLOCK_Y} (512 threads per block)" > $PERF_LOG
echo "========================================" >> $PERF_LOG

#!/bin/bash
# filepath: d:\UDL\HPC\HPC_Project\CUDA\heat_cuda_32x32.sh

# Test configuration: 32x32 blocks (1024 threads per block)
BLOCK_X=32
BLOCK_Y=32
CONFIG_NAME="block_32x32"
...
echo "Block Configuration: ${BLOCK_X}x${BLOCK_Y} (1024 threads per block)" > $PERF_LOG
echo "========================================" >> $PERF_LOG
